...
class BiDAF(nn.Module):
    ...
    """
    def __init__(self, word_vectors, with_char_embed, char_vectors, hidden_size, drop_prob=0.2): # TODO drop_prob changed based on paper
    ...
    def forward(self, cw_idxs, qw_idxs, cc_idxs, qc_idxs):  # TODO where does the cc_idxs and qc_idxs come from
        ...
        # concatenate word and character embeddings here
